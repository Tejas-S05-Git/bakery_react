        ...
        <div className="header-2">
          ...
          <div className="container">
            ...
            <div className="icon-container"> 
              <div id="search-btn" className="icon fa-solid fa-magnifying-glass"></div> {/* Search Icon */}
              ...
              <a href="Cart.html" id="cart"> {/* Cart Page Link */}
                ...
                <span className="badge">5</span> {/* Cart Items Count (Badge) */}
              </a> 
            </div>
            ...
            <form className="search-container">
              ...
              <button type="submit"><i className="fas fa-search"></i></button> {/* Submit Button */}
            </form>
          </div>
        </div>
        {/* ===== Header-2 Area (End) ===== */}
      ...
      <section className="shop">
        ...
        <div className="shop-container">
          ...
          <div className="product-container list">
            ...
            <div className="product-item"> 
              <div className="image">
                ...
                <div className="icon-box">
                  <a href="Wishlist.html" className="icon"><i className="far fa-heart"></i></a>{/* Add to Wishlist Button */}
                  <a href="Cart.html" className="icon"><i className="fa-solid fa-cart-shopping"></i></a>{/* Add to Cart Button */}
                  <a href="Product-Single.html" className="icon"><i className="fa-solid fa-magnifying-glass"></i></a>{/* Product Detail Page Button */}
                </div>
              </div>
              <div className="content">
                {/* Product Rating */}
                ...
                <a href="Product-Single.html"><h3>pancake</h3></a> {/* Product Title */}
                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptates fugit inventore numquam error odit dolorum veniam recusandae doloribus dolor et minus sed hic distinctio, tenetur, voluptatem quia excepturi maxime repellat!</p> {/* Product Description */}
                <div className="price">$10.00 <span>$12.00</span></div> {/* Product Price */}
              </div>
            </div>
            ...
            <div className="product-item"> 
              <div className="image">
                <img src={product2} alt="Product-Image" /> {/* Product Image */}
                <div className="icon-box">
                  <a href="Wishlist.html" className="icon"><i className="far fa-heart"></i></a>{/* Add to Wishlist Button */}
                  <a href="Cart.html" className="icon"><i className="fa-solid fa-cart-shopping"></i></a>{/* Add to Cart Button */}
                  <a href="Product-Single.html" className="icon"><i className="fa-solid fa-magnifying-glass"></i></a>{/* Product Detail Page Button */}
              ...
              <div className="content">
                ...
                <a href="Product-Single.html"><h3>smoothie</h3></a> {/* Product Title */}
                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptates fugit inventore numquam error odit dolorum veniam recusandae doloribus dolor et minus sed hic distinctio, tenetur, voluptatem quia excepturi maxime repellat!</p> {/* Product Description */}
                <div className="price">$12.00 <span>$16.00</span></div> {/* Product Price */}
              </div>
            </div>
            ...
            <div className="product-item"> 
              <div className="image">
                <img src={product3} alt="Product-Image" /> {/* Product Image */}
                <div className="icon-box">
                  <a href="Wishlist.html" className="icon"><i className="far fa-heart"></i></a>{/* Add to Wishlist Button */}
                  <a href="Cart.html" className="icon"><i className="fa-solid fa-cart-shopping"></i></a>{/* Add to Cart Button */}
                  <a href="Product-Single.html" className="icon"><i className="fa-solid fa-magnifying-glass"></i></a>{/* Product Detail Page Button */}
              ...
              <div className="content">
                ...
                <a href="Product-Single.html"><h3>sandwich</h3></a> {/* Product Title */}
                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptates fugit inventore numquam error odit dolorum veniam recusandae doloribus dolor et minus sed hic distinctio, tenetur, voluptatem quia excepturi maxime repellat!</p> {/* Product Description */}
                <div className="price">$10.00 <span>$12.00</span></div> {/* Product Price */}
              </div>
            </div>
            ...
            <div className="product-item"> 
              <div className="image">
                <img src={product4} alt="Product-Image" /> {/* Product Image */}
                <div className="icon-box">
                  <a href="Wishlist.html" className="icon"><i className="far fa-heart"></i></a>{/* Add to Wishlist Button */}
                  <a href="Cart.html" className="icon"><i className="fa-solid fa-cart-shopping"></i></a>{/* Add to Cart Button */}
                  <a href="Product-Single.html" className="icon"><i className="fa-solid fa-magnifying-glass"></i></a>{/* Product Detail Page Button */}
              ...
              <div className="content">
                ...
                <a href="Product-Single.html"><h3>bread</h3></a> {/* Product Title */}
                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptates fugit inventore numquam error odit dolorum veniam recusandae doloribus dolor et minus sed hic distinctio, tenetur, voluptatem quia excepturi maxime repellat!</p> {/* Product Description */}
                <div className="price">$8.00 <span>$12.00</span></div> {/* Product Price */}
              </div>
            </div>
          </div>
          {/* ===== Products (End) ===== */}
